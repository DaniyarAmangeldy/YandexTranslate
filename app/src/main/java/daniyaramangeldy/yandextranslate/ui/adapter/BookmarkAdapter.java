...
public class BookmarkAdapter extends RecyclerView.Adapter<BookmarkAdapter.BookmarksHolder> {
    private List<TranslateResponse> responseList;

    public BookmarkAdapter(List<TranslateResponse> responseList){
    ...
    class BookmarksHolder extends RecyclerView.ViewHolder{
        ...
        private void bindView(TranslateResponse response){
            ...
            textOriginal.setText(response.getText().get(0));
            textTranslate.setHint(response.getText().get(0));
